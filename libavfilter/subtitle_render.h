 ...
 * is not available, ff_sub_render_alloc() returns NULL
 ...
 */
typedef struct FFSubRenderContext FFSubRenderContext;
 ...
 * After calling this, use ff_sub_render_sample() to render
 ...
 *
 * Must be called after ff_sub_render_event().
 *
 * @param[in] ctx         rendering context
 * @param[in] text        ASS dialogue line
 * @param[in] start_ms    event start time in milliseconds
 ...
 *
 * Must be called after ff_sub_render_event(). Can be
