...
struct AVSubtitleRenderContext {
    ASS_Library  *library;
...
fail:
    avfilter_subtitle_render_freep(&ctx);
    return NULL;
}

void avfilter_subtitle_render_freep(AVSubtitleRenderContext **pctx)
{
    AVSubtitleRenderContext *ctx;
