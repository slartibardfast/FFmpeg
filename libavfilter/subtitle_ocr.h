 ...
 * Tesseract is not available, ff_sub_ocr_alloc() returns NULL
 ...
 */
typedef struct FFSubOCRContext FFSubOCRContext;
 ...
 *
 * Must be called after ff_sub_ocr_init().  The default is 6
