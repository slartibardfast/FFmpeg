 ...
 * @return newly allocated context, or NULL on allocation failure or invalid
 *         arguments (algorithm out of range, max_colors < 2 or > 256).
 *         This follows the avcodec_alloc_context3() precedent of returning
 *         NULL rather than a separate error code.
 */
